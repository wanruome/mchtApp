...
public final class DataOKHttp {
	 ...
	 * @return
	 */
	public DataOKHttp setCacheGetListener(TextCacheGetListener cacheGetListener) {
	 ...
	 * @return
	 */
	public DataOKHttp setCacheExecuteToHttp(boolean isCacheExecuteToHttp) {
	 ...
	 * @return
	 */
	public DataOKHttp setCacheSaveListener(TextCacheSaveListener cacheSaveListener) {
	 ...
	 * @return
	 */
	public DataOKHttp setHttpListener(DataHttpListener listener) {
	 ...
	 * @return
	 */
	public DataOKHttp setMode(boolean isPost, boolean isAjax) {
		this.isPost = isPost;
		this.isAjax = isAjax;
		return this;
	}
	 ...
	 * @return
	 */
	public DataOKHttp setMethodType(boolean isPost) {
		this.isPost = isPost;
		return this;
	}
	...
	// * @return
	// */
	// public DataOKHttp setResponseType(HttpConfig.RESPONSETYPE mRspType) {
	 ...
	 * @return
	 */
	private boolean httpCallBackFilter(byte[] resultData) {
		boolean isFilter = false;
		if (null != dataHttpListener) {
			isFilter = dataHttpListener.httpCallBackFilter(resultData, HttpConfig.Success);
		}
		if (isFilter) {
			if (isDebug) {
