...
class Base64 {
	/**
	 * 加密和解密的密钥，64个字符(a-zA-z0-9+/)每一个都有唯一一个，字典内顺序随意排列；
	 */
	private static final char[] legalChars = DataSecretConfig.SecretKeyForBase64.toCharArray();// 字典内顺序任意更改，只要内容保证不缺就行
