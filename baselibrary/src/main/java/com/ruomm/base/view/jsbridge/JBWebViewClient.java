package com.ruomm.base.view.jsbridge;
...
public class JBWebViewClient extends WebViewClient {

	private static final String kTag = "WVJB";
	public static final String kInterface = kTag + "Interface";
	...
	private final MyJavascriptInterface myInterface = new MyJavascriptInterface();
	...
	public JBWebViewClient(WebView webView) {
		this(webView, null);
	}

	public JBWebViewClient(WebView webView, WVJBHandler messageHandler) {
	...
	private class MyJavascriptInterface {
		...
		public void onResultForScript(String key, String value) {
			...
			log(kTag, "onResultForScript: " + value);
