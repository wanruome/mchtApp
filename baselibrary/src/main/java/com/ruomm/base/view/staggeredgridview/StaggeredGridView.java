...
public class StaggeredGridView extends ExtendableListView {
	 ...
	 * info about that position so we can maintain it's position - and reorg on orientation change.
	 */
	...
	/***
	 * Our grid item state record with {@link Parcelable} implementation so we can persist them
	 * across the SGV lifecycle.
	 */
	...
	/***
	 * Tells us the distance we've offset from the top. Can be slightly off on orientation change -
	 * TESTING
	 */
	...
	public static class GridLayoutParams extends LayoutParams {
		...
		/**
		 * Here we're making sure that all grid view items are width MATCH_PARENT and height
		 * WRAP_CONTENT. That's what this grid is designed for
		 */
