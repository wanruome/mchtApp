package com.ruomm.base.view.shadowviewhelper;
...
public class ShadowViewHelper {
	...
	public static ShadowViewHelper bindShadowHelper(ShadowProperty shadowProperty, View view, int color, float rx,
			float ry) {
	...
	private void init() {
		...
		view.setPadding(view.getPaddingLeft() + shadowOffset, view.getPaddingTop() + shadowOffset,
				view.getPaddingRight() + shadowOffset, view.getPaddingBottom() + shadowOffset);
