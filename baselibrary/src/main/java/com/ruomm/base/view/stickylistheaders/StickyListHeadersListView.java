package com.ruomm.base.view.stickylistheaders;
...
import com.ruomm.base.view.stickylistheaders.WrapperViewList.LifeCycleListener;
import com.ruomm.base.view.xlistview.XListView;
import com.ruomm.R;

/**
 * Even though this is a FrameLayout subclass we it is called a ListView. This is because of 2
 * reasons. 1. It acts like as ListView 2. It used to be a ListView subclass and i did not was to
 * change to name causing compatibility errors.
 * 
...
public class StickyListHeadersListView extends FrameLayout {
	...
	public interface OnStickyHeaderOffsetChangedListener {
		 ...
		 *            The view parent
		 * @param header
		 *            The currently sticky header being offset. This header is not guaranteed to
		 *            have it's measurements set. It is however guaranteed that this view has been
		 *            measured, therefor you should user getMeasured* methods instead of get*
		 *            methods for determining the view's size.
		 * @param offset
		 *            The amount the sticky header is offset by towards to top of the screen.
		 */
			...
			if (mHeaderId == null || mHeaderId != headerId) {
				...
				if (mOnStickyHeaderChangedListener != null) {
					mOnStickyHeaderChangedListener
							.onStickyHeaderChanged(this, mHeader, firstVisiblePosition, mHeaderId);
				}
	...
	/**
	 * Use the method with extreme caution!! Changing any values on the underlying ListView might
	 * break everything.
	 * 
