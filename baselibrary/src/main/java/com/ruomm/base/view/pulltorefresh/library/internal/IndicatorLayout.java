...
import com.ruomm.base.view.pulltorefresh.library.PullToRefreshBase;
import com.ruomm.R;
...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
	...
	public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
		...
		final int padding = getResources().getDimensionPixelSize(R.dimen.pulltorefresh_indicator_internal_padding);
		...
		switch (mode) {
			case PULL_FROM_END:
				inAnimResId = R.anim.pulltorefresh_in_from_bottom;
				outAnimResId = R.anim.pulltorefresh_out_to_bottom;
			...
			case PULL_FROM_START:
				inAnimResId = R.anim.pulltorefresh_in_from_top;
				outAnimResId = R.anim.pulltorefresh_out_to_top;
