...
public class AlbumHelper {
	...
	public List<ImageBucket> getImagesBucketList(boolean refresh) {
		...
		while (itr.hasNext()) {
			...
			if (null == imageBucket || TextUtils.isEmpty(imageBucket.bucketName)
					|| imageBucket.bucketName.equals("drawable") || imageBucket.bucketName.startsWith("drawable-")
					|| imageBucket.bucketName.startsWith("assets")) {
				continue;
			}
