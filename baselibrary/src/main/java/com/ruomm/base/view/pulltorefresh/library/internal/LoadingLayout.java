...
import com.ruomm.base.view.pulltorefresh.library.ILoadingLayout;
	...
	public LoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
		...
		switch (mode) {
			...
			default:
				...
				mRefreshingLabel = "";
				mRefreshingLabel = "";
				mPullLabel = context.getResources().getString(R.string.pull_to_refresh_form_top_pull_label);
				mRefreshingLabel = context.getResources().getString(R.string.pull_to_refresh_form_top_refreshing_label);
				mReleaseLabel = context.getResources().getString(R.string.pull_to_refresh_form_top_release_label);
				break;
		}
