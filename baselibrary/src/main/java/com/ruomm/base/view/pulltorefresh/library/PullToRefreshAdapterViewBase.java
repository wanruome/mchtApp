...
import com.ruomm.base.view.pulltorefresh.library.internal.EmptyViewMethodAccessor;
import com.ruomm.base.view.pulltorefresh.library.internal.IndicatorLayout;
import com.ruomm.R;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	private void addIndicatorViews() {
		...
		if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
			...
			params.rightMargin = getResources().getDimensionPixelSize(R.dimen.pulltorefresh_indicator_right_padding);
