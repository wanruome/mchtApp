package com.ruomm.base.view.slidingmenulib.app;
...
public class SlidingActivityHelper {
	...
	/**
	 * Controls whether the ActionBar slides along with the above view when the menu is opened, or
	 * if it stays in place.
	 * 
	 * @param slidingActionBarEnabled
	 *            True if you want the ActionBar to slide along with the SlidingMenu, false if you
	 *            want the ActionBar to stay in place
	 */
	 ...
	 * height of the view are set by default to MATCH_PARENT. To use your own layout parameters,
	...
	/**
	 * Set the behind view content to an explicit view. This view is placed directly into the behind
	 * view 's view hierarchy. It can itself be a complex view hierarchy.
	 * 
	 * @param view
	 *            The desired content to display.
	 * @param layoutParams
