...
public class RotateLoadingLayoutBak extends LoadingLayout {
	...
	public RotateLoadingLayoutBak(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
