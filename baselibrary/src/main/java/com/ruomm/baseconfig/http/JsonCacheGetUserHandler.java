...
/**
 * @author Ruby Json请求缓存手动读取
 */
public abstract class JsonCacheGetUserHandler implements TextCacheGetListener {
	...
	private boolean isCacheExecuteToHttpCallBack=false;
	 ...
	 *            缓存过期时间
	 */
	public JsonCacheGetUserHandler(long cacheOffset) {
		super();
	...
	public JsonCacheGetUserHandler(long cacheOffset, boolean isLruCache, boolean isDiskLruCache) {
		super();
