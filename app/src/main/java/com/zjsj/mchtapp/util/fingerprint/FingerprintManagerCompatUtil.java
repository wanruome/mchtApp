...
public class FingerprintManagerCompatUtil {
    private FingerprintManagerCompat mFingerprintManager;
    private KeyguardManager mKeyManager;
    private CancellationSignal mCancellationSignal;
    private Activity mActivity;

    public FingerprintManagerCompatUtil(Context ctx) {
    ...
    public void callFingerPrintVerify(final IFingerprintResultListener listener) {
        ...
        try {
            mFingerprintManager.authenticate(null, 0, null, new FingerprintManagerCompat.AuthenticationCallback() {
